...
//	store: 'OUStore',
    ...
    columns: [
		{ text: 'Förkortning', dataIndex: 'abbreviation', editor: 'textfield', filter: 'string', align: 'left', width: 100 },
		{ text: 'Svensk benämning', dataIndex: 'svName', editor: 'textfield', filter: 'string', align: 'left', flex: 1},
		{ text: 'Engelsk benämning', dataIndex: 'enName', editor: 'textfield', filter: 'string', align: 'left', flex: 1 },
 		{ text: 'Enhetstyp', dataIndex: 'unitKind', editor: 'textfield', filter: 'string', align: 'left', width: 150 },
