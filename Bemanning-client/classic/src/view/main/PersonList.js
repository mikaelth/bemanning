Ext.define('Bemanning.view.main.PersonList', {
    ...
    columns: [
		...
		{ text: 'Förnamn', dataIndex: 'givenName', editor: 'textfield', filter: 'string', align: 'left', width: 100, flex: 1},
		{ text: 'Efternamn', dataIndex: 'familyName', editor: 'textfield', filter: 'string', align: 'left', flex: 1 },
